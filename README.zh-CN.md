...
**版本 1.7.0** · 适用于 Blender **5.2+** · [GPL-3.0-or-later](LICENSE)
...
- 可自定义 HUD 强调色与缩放
- 快捷键：Ctrl+B / I / U（样式），Ctrl+Shift+L / E / R（对齐）
...
1. 从 [Releases](https://github.com/AIGODLIKE/TextHelper/releases) 下载 `TextHelper-1.7.0.zip`（发布后），或本地构建（见下）。
